  ...
  try {
    ...
    if (appointmentId) {
      ...
      try {
        ...
        if (phone) {
          const body = `Hello ${patient.name || 'Patient'}, your test results for ${testName} at ${hospitalName} are ready. Please log in to SpeciCare to view them. Reference: ${reference}`;
